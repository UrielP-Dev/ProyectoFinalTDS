...
class RecipeGUI:
    def __init__(self, root, user_data):
        ...
        list_frame = ttk.LabelFrame(main_frame, text="Lista de Recetas")
        list_frame.grid(row=0, column=1, sticky="nsew", padx=(15, 0), pady=0)
        list_frame.config(style="Custom.TLabelframe")
        ...
        self.entry_ingrediente = tk.Entry(form_frame, width=25, fg="gray", bg=COLORS['blanco'], relief=tk.FLAT, highlightbackground=BORDER_COLOR)
        self.entry_ingrediente.insert(0, "Ingresa el nombre del ingrediente")
        ...
        self.btn_agregar_ingrediente = tk.Button(form_frame, text="Agregar Ingrediente", bg=BTN_COLOR, fg=BTN_TEXT, activebackground=COLORS['verde'], activeforeground=BTN_TEXT, command=self.agregar_ingrediente, relief=tk.FLAT)
        ...
        self.btn_eliminar_ingrediente = tk.Button(form_frame, text="Eliminar Ingrediente", bg=COLORS['rojo'], fg=BTN_TEXT, activebackground=COLORS['naranja'], activeforeground=BTN_TEXT, command=self.eliminar_ingrediente, relief=tk.FLAT)
        ...
        self.btn_guardar = tk.Button(form_frame, text="Guardar Receta", bg=COLORS['verde'], fg=BTN_TEXT, width=15, command=self.guardar_receta, relief=tk.FLAT, activebackground=COLORS['verde'], activeforeground=BTN_TEXT)
        self.btn_guardar.grid(row=10, column=4, sticky="e", pady=10, padx=5)
        
        self.btn_limpiar = tk.Button(form_frame, text="Limpiar", bg=COLORS['borde'], fg=TEXT_COLOR, width=10, command=self.limpiar_formulario, relief=tk.FLAT, activebackground=COLORS['borde'], activeforeground=TEXT_COLOR)
        ...
        # Tabla de recetas
        self.tree = ttk.Treeview(list_frame, columns=("Nombre", "Descripcion"), show="headings", selectmode="browse", height=18, style="Treeview")
        self.tree.heading("Nombre", text="Nombre")
        self.tree.heading("Descripcion", text="Descripción")
        self.tree.column("Nombre", width=180, anchor="w")
        self.tree.column("Descripcion", width=300, anchor="w")
        self.tree.pack(fill=tk.BOTH, expand=True, padx=10, pady=(10, 0))
        ...
        self.btn_editar = tk.Button(btn_frame, text="Editar", width=12, command=self.cargar_receta_para_editar, bg=COLORS['naranja'], fg=BTN_TEXT, relief=tk.FLAT, activebackground=COLORS['naranja'], activeforeground=BTN_TEXT)
        self.btn_editar.pack(side=tk.RIGHT, padx=5)
        self.btn_eliminar = tk.Button(btn_frame, text="Eliminar", width=12, command=self.eliminar_receta, bg=COLORS['rojo'], fg=BTN_TEXT, relief=tk.FLAT, activebackground=COLORS['rojo'], activeforeground=BTN_TEXT)
